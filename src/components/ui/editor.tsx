...
export default ({ content }: {
  ...
  return (
    ...
    <EditorProvider slotBefore={<MenuBar />} editorProps={{attributes: {class: "px-4 p-2 min-h-[10vh] focus:border-none outline-none focus:outline-none caret-green-500 dark:bg-zinc-900 bg-zinc-100"}}} editorContainerProps={{ className: "h-full  w-screen md:max-w-[90vw] lg:max-w-[70vw] xl:max-w-[60vw] rounded-md border-[0.5px] dark:border-zinc-800 border-zinc-300" }} extensions={extensions} content={content}></EditorProvider>
    </div>
  )
}
